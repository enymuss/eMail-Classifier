...
ommitedEmailAdresses  = ["omitedEmailAdress1@adress.com", "omitedEmailAdress1@adress.com"]
for message in mailbox:
    msg = pullout(message, f.name)
    emailCaption = caption(message)
    if (not any(emailAddress in emailCaption[0] for emailAddress in ommitedEmailAdresses)) and ("toEmailAdress@adress.com" in emailCaption[1]):
